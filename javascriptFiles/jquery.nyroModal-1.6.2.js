...
jQuery(function($) {
	...
	$.fn.nyroModal.settings = {
		...
		galleryLinks: '<a href="javascript:void(0);" class="nyroModalPrev">Prev</a><a href="javascript:void(0);"  class="nyroModalNext">Next</a>', // Use .nyroModalPrev and .nyroModalNext to set the navigation link
		...
		closeButton: '<a href="javascript:void(0);" class="nyroModalClose" id="closeBut" title="close">Close</a>', // Adding automaticly as the first child of #nyroModalWrapper
		...
		contentLoading: '<a href="javascript:void(0);" class="nyroModalClose">Cancel</a>', // Loading div content

		errorClass: 'error', // CSS Error class added to the loading div in case of error
		contentError: 'The requested content cannot be loaded.<br />Please try again later.<br /><a href="javascript:void(0);" class="nyroModalClose">Close</a>', // Content placed in the loading div in case of error
